    ...
    <Root>
      ...
      <Card>
        <div className="get-involved-text flex flex-col md:justify-between md:items-start items-center w-[100%] h-[60%] md:w-[60%] md:h-[90%] lg:h-[75%]">
          ...
          <div className="get-involved-btn w-[45%] md:w-[30%] md:h-[20%] h-[24%] flex md:justify-start items-end justify-center">
            <SmallButton>
              <Image src={Heart} alt="heart" width={15} height={15}></Image>
              Donate Now
            </SmallButton>
        ...
        <div className="get-involved-img h-[40%] w-[80%] md:w-[40%] md:h-full flex justify-center items-end md:items-center ">
          <GetInvolvedImage>
            <Image className=" w-[93%] h-[93%] rounded-full" src={Donations} alt="Location" />
          </GetInvolvedImage>
        </div>
      ...
      <div className="w-[85%] h-[480px] md:h-[50%] lg:h-[70%] flex md:flex-row md:justify-between flex-col justify-center items-center">
        ...
        <div className="get-involved-img h-[204.2px] w-[80%] md:w-[40%] md:h-full flex justify-center items-end md:items-center ">
          <GetInvolvedImage>
            <Image className=" w-[93%] h-[93%] rounded-full" src={Volunteer} alt="Location" />
          </GetInvolvedImage>
        </div>
      ...
      <Card>
        ...
        <div className="get-involved-img h-[40%] w-[80%] md:w-[40%] md:h-full flex justify-center items-end md:items-center ">
          <GetInvolvedImage>
            <Image className=" w-[93%] h-[93%] rounded-full" src={Partners} alt="Location" />
          </GetInvolvedImage>
        </div>
