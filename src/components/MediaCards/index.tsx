      ...
      <MediaSection>
        ...
        <div className="media-cards w-full h-[85%] bg-[#ffff] flex flex-col justify-evenly items-center">
          <MediaCard>
            <a
              target="_blank"
              href="https://nannews.ng/2023/10/19/organisation-calls-for-coordinated-efforts-in-pursuit-of-universal-hand-hygiene/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
            ...
            <a
              target="_blank"
              href="https://www.abujadigest.info/stories/education/ngo-donates-handwashing-facilities-to-fct-school/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
            ...
            <a
              target="_blank"
              href="https://www.abujadigest.info/stories/health/world-menstrual-hygiene-day-stakeholders-call-for-early-pre-menstrual-counseling/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
          ...
          <MediaCard>
            <a
              target="_blank"
              href="https://www.ethiopianewsobserver.com/csheeh-unilever-partner-to-integrate-oral-hygiene-into-school-curricula-founder/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
            ...
            <a
              target="_blank"
              href="https://www.abujadigest.info/stories/health/stakeholders-call-for-improved-dental-health-infrastructure-in-primary-health-centers/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
            ...
            <a
              target="_blank"
              href="https://www.abujadigest.info/stories/health/world-hepatitis-day-fct-residents-get-free-vaccination/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
          ...
          <MediaCard>
            <a
              target="_blank"
              href="https://www.abujadigest.info/stories/health/health-education-group-conducts-impact-assessment-of-hygiene-facilities/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
              ...
              <div className="media-img-text h-[50%] lg:h-[25%] w-[50%] lg:w-[90%] lg:pt-4  flex flex-col items-center justify-evenly">
                <p className="text-[10px] md:text-[13px] font-bold text-center">
                  Health Education: Group Conducts Impact Assessment of Hygiene
                  Facilities
                </p>
                <span className="block text-[#058A51] text-[10px] md:text-[12px] font-semibold">
                  <p>MARCH 24, 2022</p>
            ...
            <a
              target="_blank"
              href="https://sunnewsonline.com/world-oral-health-day-ngo-partners-with-dental-association-unilever-to-enlighten-pupils/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
              ...
              <div className="media-img-text h-[50%] lg:h-[25%] w-[50%] lg:w-[100%] lg:pt-4  flex flex-col items-center justify-evenly">
                <p className="text-[10px] md:text-[13px] font-bold text-center">
                  World Oral Health Day: NGO partners with dental association,
                  Unilever to enlighten pupils
                </p>
                <span className="block text-[#058A51] text-[10px] md:text-[12px] font-semibold">
                  <p>MARCH 24, 2022</p>
                </span>
            ...
            <a
              target="_blank"
              href="https://globalhandwashing.org/global-handwashing-day/take-action/submit-events/view-events/csheeh-celebrates-global-handwashing-day-2017-in-nigeria/"
              className="media-card w-[100%] md:w-[85%] lg:w-[30%] h-[30%] lg:h-[90%]  flex lg:flex-col items-center"
            >
              <div className="media-image h-full lg:h-[75%] w-[50%] lg:w-full  flex justify-center items-center">
                <MediaImage>
...
const MediaText1 = styled.div(() => [
  tw`text-[22px] md:text-[27px] w-full h-[32%] tracking-wide text-center flex items-center md:justify-start justify-center`,
  css``,
]);
